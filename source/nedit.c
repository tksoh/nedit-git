...
static char *fallbackResources[] = {
    ...
    "*textZoomSmaller.accelerator: Ctrl<Key>KP_Subtract",    
    "*textZoomSmaller.acceleratorText: Ctrl+-",    
    "*textZoomLarger.accelerator: Ctrl<Key>KP_Add",    
    "*textZoomLarger.acceleratorText: Ctrl++",    
