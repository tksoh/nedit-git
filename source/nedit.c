...
static char *fallbackResources[] = {
    ...
    "*macroMenu.checkMacroWindow.accelerator: Alt<Key>o",
    "*macroMenu.checkMacroWindow.acceleratorText: [Shift]Alt+O",
    "*macroMenu.checkMacroWindowShift.accelerator: Shift Alt<Key>o",
